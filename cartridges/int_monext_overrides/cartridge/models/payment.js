...
function getSelectedPaymentInstruments(selectedPaymentInstruments) {
    return collections.map(selectedPaymentInstruments, function (paymentInstrument) {
        ...
        // CUSTOMIZATION, NEXT ELSE-IF BLOCK
        } else if (paymentInstrument.paymentMethod === 'MONEXT') {
            results.type = 'MONEXT';
            results.maskedCreditCardNumber = 'N/A';
            results.expirationYear = 'na';
            results.expirationMonth = 'na';
        }
